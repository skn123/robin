...
void initrobin()
{
	...
	Py_XINCREF(&Robin::Python::EnumeratedConstantTypeObject);
	...
	PyModule_AddObject(module, "EnumeratedConstantType", 
					   (PyObject*)&Robin::Python::EnumeratedConstantTypeObject);
